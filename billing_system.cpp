...
int main()
{
        ...
        cout<<"\n Total Price : "<<price;
        cout<<"\n Total Discount : "<<discount<<endl;
        cout<<"\n            **GRAND PRICE** :  "<<price-discount<<"  RS ONLY"<<"                                   UNFOLLO THE HEARD"<<endl;
        cout<<"                                                                             WITH BEST QUALITY"<<endl;
        cout<<"                 *THANKS*                                                     AND YOUR FAITH"<<endl;
        cout<<"                                                                         NEAR GRAFIC ERA BHEEMTAL"<<endl;
